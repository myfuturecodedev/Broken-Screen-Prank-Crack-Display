...
//        effectsList.clear()
//
//        effectsList.add(EffectItem("1", R.drawable.broken_screen_1, R.drawable.onboard_one, "SPIDER"))
//        effectsList.add(EffectItem("2", R.drawable.broken_screen_2, R.drawable.onboard_two, "LED_LINES"))
//        effectsList.add(EffectItem("3", R.drawable.broken_screen_3, R.drawable.onboard_three, "RAINBOW_LINES"))
//        effectsList.add(EffectItem("4", R.drawable.broken_screen_4, R.drawable.onboard_one, "BULLET_HOLES"))
//        effectsList.add(EffectItem("5", R.drawable.broken_screen_5, R.drawable.onboard_two, "GLASS_BURST"))
//        effectsList.add(EffectItem("6", R.drawable.broken_screen_6, R.drawable.onboard_three, "SIDE_CRACK"))
//        effectsList.add(EffectItem("7", R.drawable.broken_screen_7, R.drawable.onboard_one, "RAINBOW_GLITCH"))
//        effectsList.add(EffectItem("8", R.drawable.broken_screen_8, R.drawable.onboard_two, "RED_BURN_OVERLAY"))
//        effectsList.add(EffectItem("9", R.drawable.broken_screen_9, R.drawable.onboard_three, "VERTICAL_STRIPES"))
//        effectsList.add(EffectItem("10", R.drawable.broken_screen_10, R.drawable.onboard_one, "DENSE_GLASS_CRACKS"))
//        effectsList.add(EffectItem("11", R.drawable.broken_screen_11, R.drawable.onboard_two, "HORIZONTAL_LINE_GLITCH"))
//        effectsList.add(EffectItem("12", R.drawable.broken_screen_12, R.drawable.onboard_three, "BULLET_MULTIPLE_SHATTERS"))
//        effectsList.add(EffectItem("13", R.drawable.broken_screen_13, R.drawable.onboard_one, "GREEN_LINE_BURN"))
//        effectsList.add(EffectItem("14", R.drawable.broken_screen_14, R.drawable.onboard_two, "CENTER_BULLET"))
//        effectsList.add(EffectItem("16", R.drawable.broken_screen_15, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//        effectsList.add(EffectItem("17", R.drawable.broken_screen_16, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//        effectsList.add(EffectItem("18", R.drawable.broken_screen_17, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//        effectsList.add(EffectItem("19", R.drawable.broken_screen_18, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//        effectsList.add(EffectItem("20", R.drawable.broken_screen_19, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//        effectsList.add(EffectItem("20", R.drawable.broken_screen_20, R.drawable.onboard_three, "EDGE_SPIDER_WEB"))
//
//
//
//    }
    ...
    private fun initEffectsData() {
        ...
        when {
            prankType.equals("SPIDER", ignoreCase = true) -> {
                // Filter only spider & glass shatter cracks and load exactly 8 items
                val spiderCategories = listOf("SPIDER", "GLASS_BURST", "SIDE_CRACK", "DENSE_GLASS_CRACKS", "EDGE_SPIDER_WEB")
                val filtered = masterList.filter { spiderCategories.contains(it.styleCategory) }
                effectsList.addAll(filtered.take(8)) // Takes exactly 8 items
            }
            prankType.equals("LED", ignoreCase = true) || prankType.equals("LED_LINES", ignoreCase = true) -> {
                val ledCategories = listOf("LED_LINES", "RAINBOW_LINES", "RED_BURN_OVERLAY", "VERTICAL_STRIPES", "GREEN_LINE_BURN")
                val filtered = masterList.filter { ledCategories.contains(it.styleCategory) }
                effectsList.addAll(filtered)
            }
            prankType.equals("BULLET", ignoreCase = true) || prankType.equals("BULLET_HOLES", ignoreCase = true) -> {
                val bulletCategories = listOf("BULLET_HOLES", "BULLET_MULTIPLE_SHATTERS", "CENTER_BULLET")
                val filtered = masterList.filter { bulletCategories.contains(it.styleCategory) }
                effectsList.addAll(filtered)
            }
            prankType.equals("TOUCH", ignoreCase = true) || prankType.equals("RAINBOW_GLITCH", ignoreCase = true) -> {
                val touchCategories = listOf("RAINBOW_GLITCH", "HORIZONTAL_LINE_GLITCH", "GLASS_BURST", "GREEN_LINE_BURN")
                val filtered = masterList.filter { touchCategories.contains(it.styleCategory) }
                effectsList.addAll(filtered)
            }
            else -> {
